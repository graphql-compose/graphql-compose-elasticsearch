...
export function getBoolITC<TContext>(opts: CommonOpts<TContext>): InputTypeComposer<TContext> {
...
function prepareQueryMayBeArray(vals: any, fieldMap: any) {
...
export function prepareBoolInResolve(bool: any, fieldMap: any): { [argName: string]: any } {
